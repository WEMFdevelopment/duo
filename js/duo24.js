 ...
 */ !(function (t) {
    ...
    function (t, e, n) {
        ...
        var T = { clone: c, addLast: l, addFirst: d, removeLast: p, removeFirst: v, insert: h, removeAt: y, replaceAt: g, getIn: m, set: b, setIn: w, update: x, updateIn: _, merge: O, mergeDeep: I, mergeIn: j, omit: E, addDefaults: S };
        e.default = T;
    },
    function (t, e, n) {
        var r = n(1).Symbol;
    ...
    function (t, e, n) {
                ...
                switch (o) {
                    ...
                    case p.h:
                        var u = i(t, h.J),
                            ...
                            l = void 0;
                        return (
                            (f = a.widthUnit === h.a ? (T.test(u) ? parseFloat(u) : parseFloat(n.width)) : s()(parseFloat(u), parseFloat(n.width))),
                    ...
                    case h.z:
                        return (function (t, e, n, r, i) {
                            ...
                            P(t, y.d, i),
                                ...
                                (l = c.yValue),
                                (d = c.zValue),
                                ((s === p.j && void 0 !== d) || (s === p.l && void 0 !== d) || (s === p.k && (void 0 !== f || void 0 !== l))) && a(t, y.e, h.w);
                            var u, c, s, f, l, d;
                        })(t, e, n, i, a);
                    case h.y:
                        return (function (t, e, n, r, i) {
            ...
            (e.b = function (t) {
                ...
                Object.keys(o).forEach(function (t) {
                    var e = o[t],
                        ...
                        i = r.actionListId,
                        a = u[i];
                    a && D({ actionList: a, event: e, elementApi: n });
                }),
                    Object.keys(u).forEach(function (t) {
                        D({ actionList: u[t], elementApi: n });
                    });
            }),
            (e.a = function (t, e, n) {
                var r = n.setStyle,
                ...
                i(t, h.K) && z({ effect: N, actionTypeId: o, elementApi: n })(t);
            }),
            (e.i = F),
            (e.n = function (t) {
                ...
                return (
                    ...
                    Object(d.setIn)(r, ["actionLists"], m({}, e, { id: e, actionItemGroups: [{ actionItems: u }] }))
                );
            }),
            (e.r = function (t, e) {
                var n = e.basedOn;
        ...
        function S(t) {
            ...
            var A = u()(n, "action.config.affectedElements", {})[w || O] || {},
                M = Boolean(A.id || A.selector),
                k = void 0,
                L = void 0,
                C = void 0,
                P = n && c(E(n.target));
            if ((M ? ((k = A.limitAffectedElements), (L = P), (C = c(A))) : (L = C = c({ id: w, selector: O, selectorGuids: I })), n && S)) {
                var N = r && (C || !0 === S) ? [r] : s(P);
                if (C) {
                    if (S === h.g)
        ...
        var M =
                (m((o = {}), p.j, Object.freeze({ xValue: 0, yValue: 0, zValue: 0 })),
                m(o, p.l, Object.freeze({ xValue: 1, yValue: 1, zValue: 1 })),
                m(o, p.k, Object.freeze({ xValue: 0, yValue: 0, zValue: 0 })),
                m(o, p.m, Object.freeze({ xValue: 0, yValue: 0 })),
                o),
            k = Object.keys(M);
        var L = /^rgb/,
            C = RegExp("rgba?\\(([^)]+)\\)");
    ...
    function (t, e) {
        ...
        window.tram = (function (t) {
            ...
            var f = (function (t, e, r) {
                ...
                k = (e.support = { bind: Function.prototype.bind, transform: M("transform"), transition: M("transition"), backface: M("backface-visibility"), timing: M("transition-timing-function") });
            if (k.transition) {
                var L = k.timing.dom;
            ...
            var P = (e.frame = (function () {
                ...
                D = f(function (e) {
                    ...
                    function o(t, e, r) {
                        if (t) {
                            ...
                            if ((e || (this.timer && this.timer.destroy(), (this.queue = []), (this.active = !1)), "number" == o && e)) return (this.timer = new X({ duration: t, context: this, complete: a })), void (this.active = !0);
                            if ("string" == o && e) {
                                switch (t) {
                                    case "hide":
                                        f.call(this);
                            ...
                            if ("object" == o) {
                                ...
                                p.call(
                                    ...
                                    d.call(this),
                                    s > 0 && ((this.timer = new X({ duration: s, context: this })), (this.active = !0), e && (this.timer.complete = a));
                                var v = this,
                                    h = !1,
                                    y = {};
                                P(function () {
                    ...
                    (e.init = function (e) {
                        ...
                        k.backface && B.hideBackface && W(this.el, k.backface.css, "hidden");
                    }),
                        b("add", i),
                        b("start", o),
                        b("wait", function (t) {
                            (t = c(t, 0)), this.active ? this.queue.push({ options: t }) : ((this.timer = new X({ duration: t, context: this, complete: a })), (this.active = !0));
                        }),
                        b("then", function (t) {
                ...
                q = f(z, function (t, e) {
                    ...
                    (t.init = function () {
                        e.init.apply(this, arguments), this.current || ((this.current = {}), Q.perspective && B.perspective && ((this.current.perspective = B.perspective), W(this.el, this.name, this.style(this.current)), this.redraw()));
                    }),
                        (t.set = function (t) {
                ...
                U = f(function (e) {
                    function n() {
                        var t,
                            ...
                            r,
                            i = c.length;
                        if (i) for (P(n), e = N(), t = i; t--; ) (r = c[t]) && r.render(e);
                    }
                ...
                B = (e.config = { debug: !1, defaultUnit: "px", defaultAngle: "deg", keepInherited: !1, hideBackface: !1, perspective: "", fallback: !k.transition, agentTests: [] });
            (e.fallback = function (t) {
                if (!k.transition) return (B.fallback = !0);
                B.agentTests.push("(" + t + ")");
            ...
            var W = t.style,
                ...
                Q = {};
            k.transform && ((K.transform = [q]), (Q = { x: [x, "translateX"], y: [x, "translateY"], rotate: [_], rotateX: [_], rotateY: [_], scale: [m], scaleX: [m], scaleY: [m], skew: [_], skewX: [_], skewY: [_] })),
                k.transform && k.backface && ((Q.z = [x, "translateZ"]), (Q.rotateZ = [_]), (Q.scaleZ = [m]), (Q.perspective = [w]));
            var Y = /ms/,
                J = /s|\./;
            return (t.tram = e);
        })(window.jQuery);
    ...
    function (t, e, n) {
        ...
        var k = navigator.userAgent,
            L = k.match(/iPad/i) || k.match(/iPhone/),
            C = 12;
        function P(t, e) {
        ...
        function D(t, e) {
            var n = t.actionTypeId,
                ...
                s = void 0 === c || c,
                f = t.rawData;
            if ((r && i && f && u && (f = Object(O.n)({ actionListId: r, actionItemId: i, rawData: f })), V({ store: e, rawData: f, allowEvents: a }), (r && n === T.c) || N(n))) {
                                    ...
                                    ? (function (t) {
                                          ...
                                          if (c()(l)) {
                                              y()(l, function (t, e) {
                                                  ...
                                                  (u.actionTypeId === T.c || N(u.actionTypeId)) && W({ store: n, actionListId: s, eventId: c });
                                              });
                                              var d = function (t) {
                                                      var e = n.getState(),
                                                          i = e.ixSession;
        ...
        function K(t) {
            ...
            e.dispatch(Object(j.instanceAdded)(M({ instanceId: c, elementId: f, origin: p, refType: d }, r))),
        ...
        function J(t, e) {
            ...
            if (Object(O.q)(_, w.mediaQueryKey) && (r || n || i)) {
                if (s || (c === S.x && i)) {
                    ...
                    switch (A) {
                        case S.r:
                            Object(O.p)(T, M, k, l, a, y, E, c);
                    }
                }
                if (i) {
                    if (h) {
                        var L = $({ store: e, eventId: l, eventTarget: d, eventStateKey: p, actionListId: v, groupIndex: f + 1, verbose: g });
                        g && !L && e.dispatch(Object(j.actionListPlaybackChanged)({ actionListId: v, isPlaying: !1 }));
                    }
                    Q(t, e);
                }
            }
    ...
    function (t, e, n) {
        n(86), n(88), n(90), n(240), n(241), n(242), (t.exports = n(245));
    },
    function (t, e, n) {
        var r = n(3);
        r.define(
                        ...
                        /\.webflow\.io$/i.test(p) && c.hostname !== p && (u = !0),
                            u &&
                                ...
                                ((e =
                                    ...
                                    (r = t("<img>").attr("src", "https://d1otoma47x30pg.cloudfront.net/img/webflow-badge-icon.60efbf6ec9.svg").css({ marginRight: "8px", width: "16px" })),
        ...
        r.define(
            ...
            (t.exports = function (t, e) {
                ...
                function w(e, n) {
                            ...
                            !(function (e, n) {
                                ...
                                function I(t) {
                                    var r = t.responseJSON && t.responseJSON.msg,
                                        i = w;
                                    "string" == typeof r && 0 === r.indexOf("InvalidFileTypeError") ? (i = b) : "string" == typeof r && 0 === r.indexOf("MaxFileSizeError") && (i = m),
                                        p.text(i),
                    ...
                    (i.handler = null), (i.redirect = r.attr("data-redirect")), m.test(u) ? (i.handler = j) : u || (a ? (i.handler = "function" == typeof hostedSubmitWebflow ? hostedSubmitWebflow : I) : b());
                }
                function x(t) {
            ...
            c = function (t, e) {
                ...
                for (var g = void 0, m = void 0, b = void 0, w = void 0, x = 0, _ = i.length; x < _; x++) {
                    ...
                    if ((0 === x && (g = j[0]), y >= I)) {
                        ...
                        var E = i[x + 1],
                            S = E && y !== I;
                        (m = S ? E.actionItems[0] : null), S && ((b = I / 100), (w = (E.keyframe - I) / 100));
                    }
                }
                var T = {};
                if (g && !m)
                    ...
                    for (var L = (h - b) / w, C = g.config.easing, P = Object(a.a)(C, L), N = 0, D = u.length; N < D; N++) {
                        var R = u[N],
                            z = g.config[R],
                            V = (m.config[R] - z) * P + z;
                        T[R] = V;
            ...
            f = function () {
                ...
                switch (e.type) {
                    ...
                    case i.i:
                        ...
                        return Object(o.mergeIn)(t, [M], { active: !0, complete: !1, start: window.performance.now() });
                    case i.h:
                        var k = e.payload.instanceId;
                        if (!t[k]) return t;
                        for (var L = {}, C = Object.keys(t), P = C.length, N = 0; N < P; N++) {
                            var D = C[N];
                            D !== k && (L[D] = t[D]);
                        }
                        return L;
    ...
    function (t, e, n) {
        ...
        t.exports = function (t, e, n, y, g, m) {
            ...
            if (j && !O) return m || (m = new r()), b || f(t) ? i(t, e, n, y, g, m) : o(t, e, x, n, y, g, m);
            if (!(n & l)) {
    ...
    function (t, e, n) {
        ...
        var m,
            ...
            k = { types: [{ target: document, types: "scroll wheel", throttle: !0 }] },
            L =
            ...
            N = function (t) {
                return function (e) {
                    ...
                    var w = s === p.t ? v >= b + y : v <= b - y,
                        x = h({}, n, { percentTop: v, inBounds: w, anchorTop: b, scrollingDown: g });
        ...
        e.a =
                    ...
                    switch (u) {
                        ...
                        case p.q:
                            var M = L(),
                                ...
                                P = M.scrollWidth,
                                N = M.scrollHeight;
                            S = j ? Math.min(k + x, P) / P : Math.min(C + O, N) / N;
                            break;
                        case p.g:
                        default:
                            T = Object(l.j)(o, s);
            ...
            g(r, p.w, {
                ...
                handler: function (t) {
                    ...
                    var T = Object(l.j)(i, g),
                        A = e.getBoundingClientRect(),
                        M = (x ? O : 0) / 100,
                        k = (w ? j : 0) / 100;
                    (M = m ? M : 1 - M), (k = b ? k : 1 - k);
                    var C = A.top + Math.min(A.height * M, v),
                        P = A.top + A.height * k - C,
                        N = Math.min(v + P, f),
                        D = Math.min(Math.max(0, v - C), N) / N;
                    return D !== o.scrollPercent && n.dispatch(Object(d.parameterChanged)(T, D)), { scrollPercent: D };
                },
            }),
            g(r, p.x, V),
            g(r, p.y, V),
                ...
                function j(e, n) {
                    ...
                    if (e.index !== e.previous) {
                        if ("cross" === m) {
                            ...
                            return (
                                (_ = "opacity " + I + "ms " + b),
                                s(y).set({ visibility: "" }).add(_).start({ opacity: 0 }),
                                void s(h)
                        ...
                        if ("over" === m)
                            return (
                                ...
                                s(y).set({ visibility: "" }).stop(),
                                void s(h)
                                    .set({ visibility: "", zIndex: e.depth++, x: d + i[e.index].width * x })
                                    .add(O)
                                    .start({ x: d })
                                    .then(E)
                            );
                        r.infinite && c.x
                            ? (s(e.slides.not(y)).set({ visibility: "", x: c.x }).add(O).start({ x: d }), s(y).set({ visibility: "", x: c.from }).add(O).start({ x: c.to }), (e.shifted = y))
...
Webflow.require("ix2").init({
    events: {
        e: {
            ...
            target: { selector: ".link-block", originalId: "5b900cceb415298198ca4021|d96ee0be-11a8-980f-291d-28f6602c55c7", appliesTo: "CLASS" },
            config: { loop: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1525296843629,
        },
        "e-8": {
            id: "e-8",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "SLIDE_EFFECT", config: { actionListId: "e-8-slideInBottom", autoStopEventId: "e-9" }, instant: false },
            mediaQueries: ["main", "medium", "tiny", "small"],
            target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5b900cceb415298198ca4021|9bbaef71-35fe-f282-21ae-8bdd515ec7c5" },
            config: { loop: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: "BOTTOM", effectIn: true },
            createdOn: 1533745181217,
        },
        "e-9": {
            id: "e-9",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "SLIDE_EFFECT", config: { actionListId: "e-9-slideOutBottom", autoStopEventId: "e-8" }, instant: false },
            mediaQueries: ["main", "medium", "tiny", "small"],
            target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5b900cceb415298198ca4021|9bbaef71-35fe-f282-21ae-8bdd515ec7c5" },
            config: { loop: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: "BOTTOM", effectIn: false },
            createdOn: 1533745181218,
        },
        "e-10": {
            id: "e-10",
            ...
            target: { appliesTo: "PAGE", styleBlockIds: [], id: "5b900cceb415293c29ca4020" },
        ...
        "e-11": {
            ...
            target: { appliesTo: "PAGE", styleBlockIds: [], id: "5b900cceb415293c29ca4020" },
            config: [{ continuousParameterGroupId: "a-7-p", smoothing: 50, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1533849971905,
        },
        "e-12": {
            id: "e-12",
            eventTypeId: "MOUSE_CLICK",
            ...
            target: { selector: ".links-phone.div-links", originalId: "5b900cceb415293c29ca4020|0ec6cfe8-b835-50e0-cbb1-1e6cd3a85669", appliesTo: "CLASS" },
            config: { loop: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1533850387546,
        },
        "e-16": {
            id: "e-16",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "FLIP_EFFECT", config: { actionListId: "e-16-flipInBottom", autoStopEventId: "e-17" }, instant: false },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".image-amenidad", originalId: "5b900cceb415293c29ca4020|fcb9bc24-0a43-bc75-c4f0-1a508ce37a2d", appliesTo: "CLASS" },
            config: { loop: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: "BOTTOM", effectIn: true },
            createdOn: 1534263540795,
        },
        "e-17": {
            id: "e-17",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "FLIP_EFFECT", config: { actionListId: "e-17-flipOutBottom", autoStopEventId: "e-16" }, instant: false },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".image-amenidad", originalId: "5b900cceb415293c29ca4020|fcb9bc24-0a43-bc75-c4f0-1a508ce37a2d", appliesTo: "CLASS" },
            config: { loop: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: "BOTTOM", effectIn: false },
            createdOn: 1534263540796,
        },
        "e-18": {
            id: "e-18",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "SLIDE_EFFECT", config: { actionListId: "e-18-slideInLeft", autoStopEventId: "e-19" }, instant: false },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5b900cceb415293c29ca4020|f0660039-47ea-9a22-dd54-d8195f099985" },
            config: { loop: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: "LEFT", effectIn: true },
            createdOn: 1536254363345,
        },
        "e-19": {
            id: "e-19",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "SLIDE_EFFECT", config: { actionListId: "e-19-slideOutLeft", autoStopEventId: "e-18" }, instant: false },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5b900cceb415293c29ca4020|f0660039-47ea-9a22-dd54-d8195f099985" },
            config: { loop: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: "LEFT", effectIn: false },
            createdOn: 1536254363346,
        },
        "e-20": {
            id: "e-20",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "SLIDE_EFFECT", config: { actionListId: "e-20-slideInBottom", autoStopEventId: "e-21" }, instant: false },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".heading-amenidad", originalId: "5b900cceb415293c29ca4020|ed6c4dd0-fe02-ef00-6da6-4f6166bc0bf4", appliesTo: "CLASS" },
            config: { loop: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0.5, direction: "BOTTOM", effectIn: true },
            createdOn: 1536607818979,
        },
        "e-21": {
            id: "e-21",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "SLIDE_EFFECT", config: { actionListId: "e-21-slideOutBottom", autoStopEventId: "e-20" }, instant: false },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".heading-amenidad", originalId: "5b900cceb415293c29ca4020|ed6c4dd0-fe02-ef00-6da6-4f6166bc0bf4", appliesTo: "CLASS" },
            config: { loop: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: "BOTTOM", effectIn: false },
            createdOn: 1536607818980,
        },
    },
    actionLists: {
        a: {
                    ...
                    actionItems: [
                        {
                            ...
                            config: { delay: 0, easing: "", duration: 0, value: "flex", target: { selector: ".links-phone.div-links", selectorGuids: ["2e8f243f-73d6-c87e-bd21-8d8cb81aadd8", "2e8f243f-73d6-c87e-bd21-8d8cb81aaddd"] } },
                        },
                    ],
                },
            ],
            createdOn: 1525296852278,
                    ...
                    actionItems: [
                        {
                            id: "a-2-n",
                            actionTypeId: "GENERAL_DISPLAY",
                            config: { delay: 0, easing: "", duration: 0, value: "none", target: { selector: ".links-phone.div-links", selectorGuids: ["2e8f243f-73d6-c87e-bd21-8d8cb81aadd8", "2e8f243f-73d6-c87e-bd21-8d8cb81aaddd"] } },
                        },
                    ],
                },
            ],
            createdOn: 1525296873606,
            useFirstGroupAsInitialState: false,
        },
        "a-3": {
            id: "a-3",
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "5b900cceb415298198ca4021|ba79192a-6a17-0a46-208e-5053eef93180" }, yValue: 0, xUnit: "PX", yUnit: "VH", zUnit: "PX" },
                                },
                                {
                                    id: "a-3-n-3",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "5b900cceb415298198ca4021|78da1b7e-e2f1-efc4-238c-abea0a476bc6" }, yValue: 0, xUnit: "PX", yUnit: "VH", zUnit: "PX" },
                                },
                                {
                                    id: "a-3-n-5",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "5b900cceb415298198ca4021|c3245048-9088-e799-f07c-82f5af1aa7a1" }, yValue: 0, xUnit: "PX", yUnit: "VH", zUnit: "PX" },
                                },
                            ],
                        },
                        {
                            ...
                            actionItems: [
                                {
                                    id: "a-3-n-2",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "5b900cceb415298198ca4021|ba79192a-6a17-0a46-208e-5053eef93180" }, yValue: -100, xUnit: "PX", yUnit: "VH", zUnit: "PX" },
                                },
                                {
                                    id: "a-3-n-4",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "5b900cceb415298198ca4021|78da1b7e-e2f1-efc4-238c-abea0a476bc6" }, yValue: -100, xUnit: "PX", yUnit: "VH", zUnit: "PX" },
                                },
                                {
                                    id: "a-3-n-6",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "5b900cceb415298198ca4021|c3245048-9088-e799-f07c-82f5af1aa7a1" }, yValue: -100, xUnit: "PX", yUnit: "VH", zUnit: "PX" },
                                },
                            ],
                        },
                    ],
            ...
            createdOn: 1525371670454,
        },
        "a-5": {
            id: "a-5",
            title: "Scroll-Edificio-2",
            continuousParameterGroups: [
                {
                    id: "a-5-p",
                    type: "SCROLL_PROGRESS",
                            ...
                            actionItems: [
                                {
                                    id: "a-5-n",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "5b900cceb415298198ca4021|fbc211b3-481c-378d-9c80-89e0b6b3faf9" }, yValue: 0, xUnit: "PX", yUnit: "VW", zUnit: "PX" },
                                },
                                {
                                    id: "a-5-n-3",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "5b900cceb415298198ca4021|aecb2d92-48aa-42f7-e1ab-61aa840c0f73" }, yValue: 0, xUnit: "PX", yUnit: "VW", zUnit: "PX" },
                                },
                            ],
                        },
                        {
                            ...
                            actionItems: [
                                {
                                    id: "a-5-n-2",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "5b900cceb415298198ca4021|fbc211b3-481c-378d-9c80-89e0b6b3faf9" }, yValue: -30, xUnit: "PX", yUnit: "VW", zUnit: "PX" },
                                },
                                {
                                    id: "a-5-n-4",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "5b900cceb415298198ca4021|aecb2d92-48aa-42f7-e1ab-61aa840c0f73" }, yValue: 34, xUnit: "PX", yUnit: "VW", zUnit: "PX" },
                                },
                            ],
                        },
                    ],
        ...
        "a-6": {
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".header", selectorGuids: ["2e8f243f-73d6-c87e-bd21-8d8cb81aadda"] }, rValue: 0, gValue: 112, bValue: 111, aValue: 0 },
                                },
                                {
                                    id: "a-6-n-5",
                                    ...
                                    config: {
                                        ...
                                        duration: 500,
                                        locked: false,
                                        target: { selector: ".link-logo", selectorGuids: ["2e8f243f-73d6-c87e-bd21-8d8cb81aadd5"] },
                                        widthValue: 150,
                                        widthUnit: "PX",
                                        heightUnit: "PX",
                                    },
                            ...
                            actionItems: [
                                {
                                    id: "a-6-n-2",
                                    actionTypeId: "STYLE_BACKGROUND_COLOR",
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".header", selectorGuids: ["2e8f243f-73d6-c87e-bd21-8d8cb81aadda"] }, rValue: 0, gValue: 112, bValue: 111, aValue: 1 },
                                },
                                {
                                    id: "a-6-n-6",
                                    actionTypeId: "STYLE_SIZE",
            ...
            createdOn: 1525459575117,
        },
        "a-7": {
            id: "a-7",
            title: "Scroll-header-phone",
            continuousParameterGroups: [
                {
                    id: "a-7-p",
                    type: "SCROLL_PROGRESS",
        ...
        "a-8": {
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                duration: 500,
                                locked: false,
                                target: { selector: ".line-01.line-amen", selectorGuids: ["df2a02be-1fbc-641c-5f28-ce80ec79ffaa", "5d56a6d5-5f46-94e7-bb5c-acc02514863d"] },
                                widthValue: 0,
                                widthUnit: "PX",
                                heightUnit: "PX",
                            },
            ...
            createdOn: 1536606774533,
            useFirstGroupAsInitialState: true,
        },
        "a-9": {
            id: "a-9",
            title: "slide-out-line-01",
            actionItemGroups: [
                {
                    actionItems: [
                        {
            ...
            createdOn: 1536606817491,
            useFirstGroupAsInitialState: false,
        },
        "e-8-slideInBottom": {
            id: "e-8-slideInBottom",
            useFirstGroupAsInitialState: true,
            actionItemGroups: [
                { actionItems: [{ actionTypeId: "STYLE_OPACITY", config: { delay: 0, duration: 0, target: { id: null, useEventTarget: true }, value: 0 } }] },
                { actionItems: [{ actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, duration: 0, target: { id: null, useEventTarget: true }, xValue: 0, yValue: 100, xUnit: "PX", yUnit: "PX", zUnit: "PX" } }] },
                {
                    actionItems: [
        ...
        "e-9-slideOutBottom": {
            id: "e-9-slideOutBottom",
            actionItemGroups: [
                {
                    actionItems: [
                        { actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "inQuart", duration: 1000, target: { id: null, useEventTarget: true }, value: 0 } },
                        { actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "inQuart", duration: 1000, target: { id: null, useEventTarget: true }, xValue: 0, yValue: 100, xUnit: "PX", yUnit: "PX", zUnit: "PX" } },
                    ],
                },
            ],
        },
        "e-16-flipInBottom": {
            id: "e-16-flipInBottom",
            useFirstGroupAsInitialState: true,
            actionItemGroups: [
                { actionItems: [{ actionTypeId: "STYLE_OPACITY", config: { delay: 0, duration: 0, target: { id: "5b900cceb415293c29ca4020|fcb9bc24-0a43-bc75-c4f0-1a508ce37a2d", useEventTarget: true }, value: 0 } }] },
                {
                    actionItems: [
                        {
                            ...
                            config: {
                                delay: 0,
                                duration: 0,
                                target: { id: "5b900cceb415293c29ca4020|fcb9bc24-0a43-bc75-c4f0-1a508ce37a2d", useEventTarget: true },
                                xValue: -90,
                                yValue: 0,
                                zValue: 0,
                                xUnit: "DEG",
                ...
                },
                {
                    actionItems: [
                        ...
                        { actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "outQuart", duration: 1000, target: { id: "5b900cceb415293c29ca4020|fcb9bc24-0a43-bc75-c4f0-1a508ce37a2d", useEventTarget: true }, value: 1 } },
                    ],
                },
            ],
        },
        "e-17-flipOutBottom": {
            id: "e-17-flipOutBottom",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                        ...
                        { actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "inQuart", duration: 1000, target: { id: "5b900cceb415293c29ca4020|fcb9bc24-0a43-bc75-c4f0-1a508ce37a2d", useEventTarget: true }, value: 0 } },
                    ],
                },
            ],
        },
        "e-18-slideInLeft": {
            ...
            actionItemGroups: [
                { actionItems: [{ actionTypeId: "STYLE_OPACITY", config: { delay: 0, duration: 0, target: { id: null, useEventTarget: true }, value: 0 } }] },
                { actionItems: [{ actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, duration: 0, target: { id: null, useEventTarget: true }, xValue: -100, yValue: 0, xUnit: "PX", yUnit: "PX", zUnit: "PX" } }] },
                {
                    actionItems: [
                        { actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "outQuart", duration: 1000, target: { id: null, useEventTarget: true }, value: 1 } },
                        { actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "outQuart", duration: 1000, target: { id: null, useEventTarget: true }, xValue: 0, yValue: 0, xUnit: "PX", yUnit: "PX", zUnit: "PX" } },
        ...
        "e-19-slideOutLeft": {
            id: "e-19-slideOutLeft",
            actionItemGroups: [
                {
                    actionItems: [
                        { actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "inQuart", duration: 1000, target: { id: null, useEventTarget: true }, value: 0 } },
                        { actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "inQuart", duration: 1000, target: { id: null, useEventTarget: true }, xValue: -100, yValue: 0, xUnit: "PX", yUnit: "PX", zUnit: "PX" } },
                    ],
                },
            ],
        },
        "e-20-slideInBottom": {
            id: "e-20-slideInBottom",
            useFirstGroupAsInitialState: true,
            actionItemGroups: [
                { actionItems: [{ actionTypeId: "STYLE_OPACITY", config: { delay: 0, duration: 0, target: { id: "5b900cceb415293c29ca4020|ed6c4dd0-fe02-ef00-6da6-4f6166bc0bf4", useEventTarget: true }, value: 0 } }] },
                {
                    actionItems: [
                        {
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 0.5, duration: 0, target: { id: "5b900cceb415293c29ca4020|ed6c4dd0-fe02-ef00-6da6-4f6166bc0bf4", useEventTarget: true }, xValue: 0, yValue: 100, xUnit: "PX", yUnit: "PX", zUnit: "PX" },
                        },
                    ],
                },
                {
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "outQuart",
                                duration: 1000,
                                target: { id: "5b900cceb415293c29ca4020|ed6c4dd0-fe02-ef00-6da6-4f6166bc0bf4", useEventTarget: true },
                                xValue: 0,
                                yValue: 0,
                                xUnit: "PX",
                                yUnit: "PX",
                        ...
                        { actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "outQuart", duration: 1000, target: { id: "5b900cceb415293c29ca4020|ed6c4dd0-fe02-ef00-6da6-4f6166bc0bf4", useEventTarget: true }, value: 1 } },
                    ],
                },
            ],
        },
        "e-21-slideOutBottom": {
            id: "e-21-slideOutBottom",
            actionItemGroups: [
                {
                    actionItems: [
                        { actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "inQuart", duration: 1000, target: { id: "5b900cceb415293c29ca4020|ed6c4dd0-fe02-ef00-6da6-4f6166bc0bf4", useEventTarget: true }, value: 0 } },
                        {
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                delay: 0,
